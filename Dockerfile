...
COPY ./yarp-device-realsense2 /home/$username/yarp-device-realsense2
RUN  cd /home/$username/yarp-device-realsense2 && \
     cd build && \
     rm -rf ./* && \
     cmake .. && \
     make -j4 && \
...
COPY ./yarp-ros2 /home/$username/yarp-ros2
RUN chown -R $username: /home/$username/yarp-ros2 && \
    cd /home/$username/yarp-ros2/ros2_interfaces_ws && \
    bash -c " \
        source /opt/ros/foxy/setup.bash && \
...
COPY ./robots-configuration /home/$username/robots-configuration
